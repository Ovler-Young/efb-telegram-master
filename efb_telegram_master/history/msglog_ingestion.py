...
from efb_telegram_master.core.models import MsgLogIngestionLeaseLostError
...
from efb_telegram_master.runtime.mtproto import MTProtoClient, MTProtoRetryableError
...
class MsgLogIngestionService:
    ...
    async def run(self, source_chat_id: int, *, lease_owner: str, stop_requested: Callable[[], bool] = lambda: False) -> bool | None:
