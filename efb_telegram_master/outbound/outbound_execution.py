...
from efb_telegram_master.outbound.outbound_types import ExecutorSubmitError, OutboundLifecycle, QueueError, SchedulerStoppedError, SenderSelection, cleanup_upload_paths, rewind_uploads
from efb_telegram_master.outbound.sender_policy import retry_after_seconds
from efb_telegram_master.transport.telegram_calls import PrimaryExecution

if TYPE_CHECKING:
    from efb_telegram_master.outbound.outbound import OutboundQueue, _PendingCall
