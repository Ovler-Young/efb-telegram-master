...
from efb_telegram_master.outbound.membership_lifecycle import MembershipLifecycle, MembershipProbeMetrics

if TYPE_CHECKING:
    from efb_telegram_master.transport.telegram_sync_bridge import AsyncTelegramRuntime, SyncBotFacade
...
class AuxiliaryBot:
    ...
    def bind_runtime(self, runtime: "AsyncTelegramRuntime") -> None:
        from efb_telegram_master.transport.telegram_sync_bridge import SyncBotFacade
